...
public class NotificationService extends Service {
  ...
  public void onCreate() {
    ...
    Intent intent = new Intent(getApplicationContext(), RewriteWord.class);
    ...
    notificationBlinker = new Runnable() {
      ...
      public void run() {
        String notifyText;
        try {
          info = db.readAlarmInfo(currentAlarmId());
    ...
    autoCancel = new Runnable() {
      @Override
      public void run() {
        Log.d("DEBUG",String.format("gameType khi truoc bao thuc la %d",gameType));
        try {
        ...
        switch (gameType){
          case 1:
            alarmIntent = new Intent(getApplicationContext(), RewriteWord.class);
            break;
          case 0:
            alarmIntent = new Intent(getApplicationContext(), MathActivity.class);
            break;
          case 2:
            alarmIntent = new Intent(getApplicationContext(), ShakephoneActivity.class);
            break;
        }
        Log.d("DEBUG",String.format("gameType khi bao thuc la %d",gameType));
        alarmIntent.putExtra(MathActivity.TIMEOUT_COMMAND, true);
  ...
  private void handleStart(Intent intent) {
    ...
    if (intent != null && intent.getData() != null) {
      ...
      Log.d("DEBUG",String.format("gameType la %d",gameType));
