...
public final class AlarmSettings {
  ...
  public ContentValues contentValues(long alarmId) {
    ...
    values.put(DbHelper.SETTINGS_GAME_TYPE, gameType);
    values.put(DbHelper.SETTINGS_GAME_DIFFICULTY, gameDifficulty);
    return values;
  }
  ...
  static public String[] contentColumns() {
    return new String[] {
      ...
      DbHelper.SETTINGS_GAME_TYPE,
      DbHelper.SETTINGS_GAME_DIFFICULTY
    };
  }
  ...
  public AlarmSettings(AlarmSettings rhs) {
    ...
    gameDifficulty = rhs.gameDifficulty;
  }
  ...
  public AlarmSettings(Cursor cursor) {
    ...
    gameType = cursor.getInt(cursor.getColumnIndex(DbHelper.SETTINGS_GAME_TYPE));
    gameDifficulty = cursor.getInt(cursor.getColumnIndex(DbHelper.SETTINGS_GAME_DIFFICULTY));
  }
  ...
  public void setGameDiff(int diff){this.gameDifficulty = diff;}

  public int getGameDiff() {return gameDifficulty;}
}
